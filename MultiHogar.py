...
#    print dias
    ...
    gps = open("ArchivosGPS/"+str(file),"r")
    for texto in gps:
...
for file in os.listdir(location):
    ...
    lector = open("ArchivosLectores/"+file,"r")
    ...
    if contador > 0:
        ...
        folium.features.Circle(location=[lapromedio, lopromedio], radius=1500,
                        popup='Sector', line_color='#3186cc',
                        fill_color='#1778c8').add_to(archivos[mapa])
        #circulo = folium.Circle(
        #    radius=1000,
        #    location=[lapromedio, lopromedio],
        #    popup='Sector',
        ...
        archivos[mapa].save("rendiciones/"+nombreSector+".html")
